...
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADORA!!\`\`\`` }
...
//info-cuenta-oficial.js
const smsOfc1 = () => { return '🌸 *◜CUENTA OFICIAL◞* 🌸'}
const smsOfc2 = () => { return `*❥ _Siguenos en las Cuenta Oficial para mantenerte al tanto de_ ${packname}*`}
...
const smsContacto4 = () => { return 'Contacto Oficial de SharkLite 🦈'}
...
const smsIAimage2 = () => { return 'Un shark de color morado con celeste estando en Júpiter, iluminando el cosmo con su encanto con un efecto minimalista.'} 
